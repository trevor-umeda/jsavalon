var AvalonPlayer = function(roleCard,playerId){
    ...
    this.assignToQuest = function(){
        this.isOnQuest = true;
    }

    this.deassignToQuest = function(){
        this.isOnQuest = false;
    }

    this.activateSubmitPlayersOnQuest = function(){
        this.actions['waiting'] = false;
        this.actions['submitPlayersOnQuest'] = true;
    }

    this.deactivateSubmitPlayersOnQuest = function(){
        this.actions['waiting'] = false;
        this.actions['submitPlayersOnQuest'] = false;
    }

    this.activateVoteForQuestPlayers = function(){
        this.actions['waiting'] = false;
        this.actions['submitPlayersOnQuest'] = false;
